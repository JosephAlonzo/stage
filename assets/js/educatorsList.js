$(document).ready(function() {
    $('#educatorsList tfoot th').each( function (k, v) {
        var title = $(this).text();
        if (title != "Actions")
        {
    ...
    var table = $('#educatorsList').DataTable({
        dom: 'Bfrtip',
        columnDefs: [
        ...
        serverSide: true,
        ajax: {
            "url": $('#educatorsList').data('pathroute'),
            "type": "POST"
        },
        stateSave: true,
        initComplete: function () 
        {
            ...
            api.buttons().container().appendTo('#educatorsList .col-md-6:eq(0)');
        ...
        lengthChange: false,
        language: {
            "url": $('#educatorsList').data('pathlanguage')
        },
        buttons: [
            { 
                extend: 'pageLength',
