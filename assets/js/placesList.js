$(document).ready(function() {
    $('#placesList tfoot th').each( function (k, v) {
        var title = $(this).text();
        if (title != "Actions")
        {
    ...
    var table = $('#placesList').DataTable({
        dom: 'Bfrtip',
        columnDefs: [
            { "name": "name", "targets": 0 },
        ...
        initComplete: function () 
        {
            ...
            api.buttons().container().appendTo('#placesList .col-md-6:eq(0)');
        ...
        lengthChange: false,
        language: {
            "url": $('#placesList').data('pathlanguage')
        },
        buttons: [
            { 
                extend: 'pageLength',
