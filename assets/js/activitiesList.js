$(document).ready(function() {
    $('#activitiesList tfoot th').each( function (k, v) {
        var title = $(this).text();
        if (title != "Actions")
        {
    ...
    var table = $('#activitiesList').DataTable({
        ...
        serverSide: true,
        ajax: {
            "url": $('#activitiesList').data('pathroute'),
            "type": "POST"
        },
        stateSave: true,
        initComplete: function () 
        {
            ...
            api.buttons().container().appendTo('#activitiesList .col-md-6:eq(0)');
        ...
        lengthChange: false,
        language: {
            "url": $('#activitiesList').data('pathlanguage')
        },
        buttons: [
            { 
                extend: 'pageLength',
